...
class TranslateHooks implements RevisionRecordInsertedHook {
    ...
    public static function custom4training( array &$names, $code ) {
        $availableLanguages = array('de','en','tr','sq','fa','ar','ku','ku-sinj','ru','ru-cars','ss','pt','pt-br','ms','es','fr','ro','hu','ur','vi','ur','pl','cs','id','zh','ko','bg','it','az','sw','ps','rn','sk','sl','hr','te','ka','uk','ky','et','ti','xh','af','sv','ckb','tr-tanri','ta','th','uz','uz-cyrl','ar-urdun','ha','hi','ml','kn','nl','sr','nb','lg','ki');
